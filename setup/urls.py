...
urlpatterns = [
    ...
    path('auth/', views.obtain_auth_token) # Habilitando o mecanismo de Tokens para autenticação(criar um token para o admin e testar o login http://127.0.0.1:8000/auth/)
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # Implementando imagens na API
